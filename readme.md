...
| **Number of doors** | Numerical | Total number of doors on the car body. |
...
1. **Outlier removal**: Removes cars with a price far from the normal range, based on brand and car age.
...
| :--- | :---: | :---: | :---: |
| **XGBoost** | **18.17** | **12,056.95** | **24,569.91** |
| Random Forest | 19.91 | 13,754.21 | 27,805.76 |
| Linear Regression | 20.78 | 14,115.82 | 28,253.17 |
